...
<html lang="en">
	...
	<body>
		...
		<div class="gridContainer">
			...
			<aside id="portrait">
				<img class="image" src="images/JohnMeyer.jpg" alt="Photo of John Meyer" />
			</aside>
			<main>				
			...
			<footer>
				<p><small>&copy; 2021 by <a href="contact.php">John Meyer</a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/?uri=referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
			</footer>
		</div>
	</body>
</html>